	...
	<ul class="comment-list">
	   <li id="52" class="comment-list-item">   
	      <div class="comment-nick-area">    
	       ...
	       <li id="53" class="comment-list-item comment-list-item--reply lev1"> 
	      <div class="comment-nick-area">    
	         <img src="image/profile.png" alt="프로필 사진" width="36" height="36">    
	         <div class="comment-box">      
	            <div class="comment-nick-box">            
	          ...
	          <div class="comment-text-box">       
	             <p class="comment-text-view">         
	                <span class="text-comment">오늘도 행복하세요</span>       
	             </p>    
	          </div>    
	          <div class="comment-info-box">      
	             <span class="comment-info-date">2022-08-05 14:07:15</span>  
	             <a href="javascript:replyform(53,1,1,53)" class="comment-info-button">답글쓰기</a>   
	          </div>
	          <div class="comment-tool">    
	             <div title="더보기" class="comment-tool-button">       
	              <div>...</div>    
	             </div>    
	             <div id="comment-list-item-layer53" class="LayerMore">     
	              <ul class="layer-list">      
	                 <li class="layer-item">       
	                   <a href="javascript:updateForm(53)" class="layer-button">수정</a>&nbsp;&nbsp;       
	                   <a href="javascript:del(53)" class="layer-button">삭제</a>
	                 </li>
	              </ul>    
	             </div>   
	           </div>
